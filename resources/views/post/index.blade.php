                    ...
                    @forelse ($posts as $post)
                        ...
                        <div
                            ...
                            <a href="#" class="w-43 h-43">
                                <img class="w-48 h-48 object-cover rounded-l-lg" src="{{ Storage::url($post->image) }}" alt="https://flowbite.com/docs/images/blog/image-1.jpg" />
                            </a>
                            <div class="p-5">
                                <a href="{{ route('post.show',['username' => 
                                $post->user->username,
                                'post' => $post->slug
                                ]) }}">
                                ...
                                <div class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ Str::words($post-> content , 15)}}</div>
                                <a href="#" >
                                    <x-primary-button>
                                    Read more
