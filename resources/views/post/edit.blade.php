<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-3xl mb-4">Update Post: <strong class="font-bold">{{$post->title}}</strong>
            </h1>
                        ...
                        shadow-sm">
                            ...
                            <div class="mt-4">
                                ...
                                <x-input-textarea id="content" class="block mt-1 w-full" type="content" name="content"
                                    required autofocus>{{ old('content', $post->content) }}</x-input-textarea>
                                ...
                                <x-input-error :messages= "$errors->get('published_at')" class="mt-3" />
                            </div>
