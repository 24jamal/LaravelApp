<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="username" name="username" type="text" class="mt-1 block w-full" :value="old('username', $user->username)" required autofocus ausernameutocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-input-textarea id="bio" class="block mt-1 w-full" type="bio"
